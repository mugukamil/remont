<?php
	...
	$phone = $leadData['custom_U299'];
	$name = $leadData['custom_U340'];
	$EMAIL_WORK = $leadData['custom_U352'];	
    ...
    curl_setopt($ch, CURLOPT_POSTFIELDS, array(
        ...
        "to"        =>  "77772375042",
        "text"      =>  iconv("windows-1251","utf-8","New lead! $phone,Tel: $name,$EMAIL_WORK")
...
if ($_SERVER['REQUEST_METHOD'] == 'POST')
{
    ...
    $postData = array(
        'TITLE' => $metka, 
        'NAME' => $leadData['custom_U299'], 
        'PHONE_WORK' =>$leadData['custom_U340'],
		'UF_CRM_1465545606' =>$leadData['custom_U352'],
    );
...
$form = array(
	'subject' => 'Отправка Форма Дизайн интерьера (Верхняя)',
	...
	'fields' => array(
		...
		'custom_U352' => array(
			...
			'required' => true,
			'errors' => array(
				'required' => 'Поле \'Площадь квартиры\' не может быть пустым.'
			)
		)
	)
);
